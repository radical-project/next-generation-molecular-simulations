...
\item Computationally Steered and Adaptive workflows: Adaptive workflows can be
  ...
  dynamics and methods that depend upon determining collective
  variables on the fly demand adaptive workflows~\cite{cecilia1} .  Computational
  ...
  data. Streaming-data steered simulations to integrate experiments,
  simulations, and analysis will be needed to take full advantage of
  experimental facilities such as high energy light sources~\cite{jha1}.
  Frameworks and libraries that will support the coupling of multi-physics
  high-performance simulations and hybrid computational processes will be
  required.
